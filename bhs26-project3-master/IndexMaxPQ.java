...
public class IndexMaxPQ<Key extends Comparable<Key>> implements Iterable<Integer> {
     ...
     */
    public IndexMaxPQ(int maxN,int id) {
    ...
    public void printIt() {
    	for(int i = 0; i< this.keys.length; i++) {
    		if(this.qp[i] != -1)
    			System.out.println(this.qp[i] + " " + this.keys[i] );
    	}
    }
    /**
    ...
    ***************************************************************************/
    ...
    private class HeapIterator implements Iterator<Integer> {
        ...
        public HeapIterator() {
            copy = new IndexMaxPQ<Key>(pq.length - 1,0);
            for (int i = 1; i <= n; i++)
    ...
    public static void main(String[] args) {
        ...
        IndexMaxPQ<String> pq = new IndexMaxPQ<String>(strings.length,0);
